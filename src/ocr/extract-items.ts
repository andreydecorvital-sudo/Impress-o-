...
const blocked = /DESTINAT|ENDERE[CÇ]O|CEP|RASTREIO|TRACKING|CHECKLIST|ATEN[CÇ][AÃ]O|PEDIDO|VARIA[CÇ][AÃ]O|PRODUTO|SELLER|VALOR|TOTAL/i;
const knownProduct = /CAPIM|BUCHINH|PLACA|P[EÉ]TALA|PARAFUS|BUCHA|COLA|JARDIM|PAMPAS/i;
